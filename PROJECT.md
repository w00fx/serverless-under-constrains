...
Delivery tasks add the Study 1 toolchain and implementation under `study-1/`. The repository does not use a top-level `specs/`, `studies/`, or `packages/runner` tree.
